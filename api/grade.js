...
- BÀI NỘP FILE POWERPOINT (.pptx): mỗi slide tách theo từng dòng/đoạn văn, có chú thích TƯƠNG TỰ file Word: [b]chữ đậm[/], [i]chữ nghiêng[/], [u]gạch chân[/], [color=#RRGGBB]chữ có màu[/], [size=32pt]chữ cỡ 32[/] (kết hợp được nhiều thuộc tính, ví dụ [b color=#00B050 size=24pt]). Ngoài ra đầu MỖI DÒNG có thể có [align=giữa|trái|phải|đều hai bên] cho biết đoạn văn đó được căn lề thế nào trong slide — [align=giữa] nghĩa là ĐÃ căn giữa, KHÔNG có [align=...] ở đầu dòng nghĩa là dùng căn lề mặc định (thường là căn trái). Chữ không có ngoặc [...] là chữ dùng định dạng mặc định (không đậm/nghiêng/gạch chân/màu/cỡ riêng). Đây LÀ định dạng THẬT của bài nộp — dùng đúng nó để chấm tiêu chí về cỡ chữ/đậm/nghiêng/gạch chân/màu chữ/căn lề, TUYỆT ĐỐI không suy diễn định dạng ngoài những gì được chú thích. Lưu ý: hệ thống KHÔNG đọc được ảnh/hình vẽ/bảng biểu chèn trong slide (chỉ đọc được chữ) — không được kết luận "chưa chèn ảnh/hình" nếu đề có yêu cầu đó, chỉ chấm được phần chữ và định dạng chữ.
